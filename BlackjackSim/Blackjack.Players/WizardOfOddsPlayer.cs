...
{
    public class WizardOfOddsPlayer : BlackjackPlayerBase
    {
        // Link to guide: http://wizardofodds.com/games/blackjack/

        public WizardOfOddsPlayer(string inName, double inBet = 10) : base(inName, inBet) { }
